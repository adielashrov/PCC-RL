...
print("gamma = %f" % gamma)
model = PPO1(MyMlpPolicy, env, verbose=2, schedule='constant', timesteps_per_actorbatch=8192, optim_batchsize=1024, gamma=gamma)
...
##
default_export_dir = "/Users/ashrov/Documents/Dropbox/Adiel Guy/DNNProject/PCC-RL/model_10_2/"
